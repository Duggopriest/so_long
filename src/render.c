...
void	player_animation(int j, int i, t_render *r)
{
	...
	mlx_put_image_to_window(r->mlx,
		r->mlx_win, r->t->ground, i * 50 + 5, j * 50 + 5);
	if (b == 1)
	{
		b = 0;
		mlx_put_image_to_window(r->mlx,
			r->mlx_win, r->t->player, i * 50 + 10, j * 50 + 10);
	}
	else
	{
		b = 1;
		mlx_put_image_to_window(r->mlx,
			r->mlx_win, r->t->player2, i * 50 + 5, j * 50 + 5);
	}
	r->py = j;
	r->px = i;
}
...
void	draw_map(char c, int j, int i, t_render *r)
{
	if (c == 'P')
		...
		mlx_put_image_to_window(r->mlx,
			r->mlx_win, r->t->obj, i * 50 + 5, j * 50 + 5);
	else if (c == 'E')
		mlx_put_image_to_window(r->mlx,
			r->mlx_win, r->t->exit, i * 50 + 5, j * 50 + 5);
	else if (c == '1')
		mlx_put_image_to_window(r->mlx,
			r->mlx_win, r->t->wall, i * 50 + 5, j * 50 + 5);
	else if (c == 'B')
		mlx_put_image_to_window(r->mlx,
			r->mlx_win, r->t->bad, i * 50 + 5, j * 50 + 5);
}
